          ...
          <div style={{ background: '#fff', borderRadius: 16, padding: 32, maxWidth: 520, width: '90%', boxShadow: s.shadowLg, maxHeight: '90vh', overflowY: 'auto' }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <input value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} style={s.input} placeholder="e.g., Resistance Bands (10-pack)" />
              </div>
              <div>
                <label style={s.label}>Category</label>
                <select value={form.category} onChange={e => setForm({ ...form, category: e.target.value })} style={{ ...s.input, cursor: 'pointer' }}>
                  <option>Equipment</option><option>Accessories</option><option>Supplies</option><option>Retail</option>
                </select>
              </div>
              <div>
              ...
              <div>
                ...
                <input value={form.lotNumber} onChange={e => setForm({ ...form, lotNumber: e.target.value })} style={s.input} placeholder="e.g., EQ-2026-0312" />
              </div>
              <div>
