...
export default function BookOnline() {
  ...
  function generateICS() {
    ...
    a.href = url;
    a.download = `booking-${booked.id}.ics`;
    a.click();
  ...
  return (
    <div ref={containerRef} className="book-page" style={{
      ...
      <div style={{
        ...
        {/* ════════════════════════════════════════ */}
        {step === 1 && !booked && (
          <div className="book-fadeInUp book-stagger-2" style={{ marginBottom: 32 }}>
            <div style={{
            ...
            <div style={{
              ...
              {/* Offer 1: Unlimited First Month */}
              <div
                onClick={() => {
                  const svc = services.find(sv =>
                    sv.name.toLowerCase().includes('unlimited') ||
                    sv.name.toLowerCase().includes('first month') ||
                    sv.name.toLowerCase().includes('intro month')
                  );
                  if (svc) {
                  ...
                  setTimeout(() => {
                    const el = document.querySelector('[data-section="service-list"]');
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.boxShadow = `0 12px 40px ${s.accent}18, 0 2px 6px rgba(0,0,0,0.04)`;
              ...
              >
                ...
                <span style={{
                  ...
                  fontSize: 9, fontFamily: s.MONO, fontWeight: 700,
                ...
                <div style={{
                  ...
                  boxShadow: `0 3px 14px ${s.accent}35`,
              ...
              {/* Offer 2: Intro Private Session */}
              <div
                onClick={() => {
                  const svc = services.find(sv =>
                    sv.name.toLowerCase().includes('intro private') ||
                    sv.name.toLowerCase().includes('intro session') ||
                    sv.name.toLowerCase().includes('private')
                  );
                  if (svc) {
                    setSelectedService(svc);
                    setActiveCategory('All');
        ...
        {step === 1 && (
          <div className="book-slideIn" key="step1">
            ...
            {/* Service cards */}
            <div data-section="service-list" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        {booked && (
          <div className="book-scaleIn" key="success" style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 14, color: s.text3, marginTop: 8, marginBottom: 32 }}>
              Your booking has been requested. We'll confirm shortly.
            </p>
